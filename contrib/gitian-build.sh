...
VERSION=
commit=false
url=https://github.com/ColossusCoinXT/ColossusCoinXT
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/ColossusCoinXT/ColossusCoinXT
...
then
    ...
    git clone https://github.com/ColossusCoinXT/colx-detached-sigs.git
