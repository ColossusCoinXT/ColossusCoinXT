...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000006dc5f1106f1897a36b4e95d039c8bcd24cffe5a52c83e49e55e379ed1db"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1517769883, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x000000901672c7c3fe141e5897586169c836606db32d5b8642b4902864321361"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0x059032e2f753d810aa1a2a37b7c76053db504cbc802bc0b09c5008f309b59716"));
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "2018-02-04 10:49 AM : Bitcoin Block Hash for Height 507629 : 0000000000000000004fa70004b04f4a479545ab8a69fc1c4e11c323daf79728";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1517769883;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1651558;
/*
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1517769999;
        genesis.nNonce = 1269210;
/*
        if (true && genesis.GetHash() != hashGenesisBlock)
            {
            printf("Searching for genesis block...\n");
...
*/
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000000901672c7c3fe141e5897586169c836606db32d5b8642b4902864321361"));
...
*/
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 33333;
        assert(hashGenesisBlock == uint256("0x059032e2f753d810aa1a2a37b7c76053db504cbc802bc0b09c5008f309b59716"));
